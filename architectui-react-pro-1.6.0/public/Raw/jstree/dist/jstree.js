		...
		$.vakata.context = {
			...
			show : function (reference, position, data) {
				...
				if(vakata_context.items.length) {
					...
					// console.log(document.getElementById("fullscreen").style.height);
					vakata_context.element.appendTo(document.fullscreenElement ? '#fullscreen' : 'body');
					...
					vakata_context.element
						.css({ "left" : x, "top" : y , "z-index" : 100000})
						.show()
	...
	$(function() {
		...
		$(document)
			.on('dnd_start.vakata.jstree', function (e, data) {
				...
				marker.appendTo(document.fullscreenElement ? '#fullscreen' : 'body'); //.show();
			})
				...
				if(!vakata_dnd.is_drag) {
					if(
						...
						if(vakata_dnd.helper) {
							vakata_dnd.helper.appendTo(document.fullscreenElement ? '#fullscreen' : 'body');
