...
class ThemeOptions extends Component {
    ...
    constructor(props) {
        ...
        const jstreecss = document.createElement("link");
        jstreecss.href = "/Raw/jstree/dist/themes/default/style.css";
        jstreecss.rel = 'stylesheet';
        document.body.appendChild(jstreecss);

        const jstree = document.createElement("script");
        jstree.src = "/Raw/jstree/dist/jstree.min.js";
        jstree.async = true;
        document.body.appendChild(jstree);

        const jqdatetimecss = document.createElement("link");
        jqdatetimecss.href = "/Raw/timepicker/jquery.timepicker.min.css";
        jqdatetimecss.rel = 'stylesheet';
        document.body.appendChild(jqdatetimecss);

        const jqdatetime = document.createElement("script");
        jqdatetime.src = "/Raw/timepicker/jquery.timepicker.min.js";
        jqdatetime.async = true;
        document.body.appendChild(jqdatetime);
